...
return [
    'students' => [
        ...
        [
            ...
            'genere' => 'f',
            'ruolo' => 'web developer',
            'descrizione' => 'Ha scoperto la passione per informatica creando un blog di psicologia, ambito in cui si era specializzata durante gli studi. Il suo cuore però non vuol sentir ragione e Loana cambia carriera e diventa una ricercatissima sviluppatrice web.'
        ],
        [
            'id' => 4,
